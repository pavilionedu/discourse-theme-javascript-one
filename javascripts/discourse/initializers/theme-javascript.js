...
*
*              When you're done looking through the Plugin API see if you can
...
*
*              See if you can use the client side event bus to make Clippy say
*              something whenever you open the composer. Then see if you can make
*              him perform different animations when you type something in the
...
*              good idea to thoroughly re-check the available API methods before
*              you consider using the "fallback" API method ``modifyClass`` which
...
*              best to use that.
*
*              See if you can find a method in the api that will let you check
*              whether a post contains the words "I hate Clippy", then prevent
*              such a post from being posted, and get Clippy to say a disapproving
*              message in response. You'll need to use some of the codebase
*              searching skills we covered in previous units.
*/
/* /learning_step */